...
import FindMatchFilterScreen from "./FindMatchFilterScreen";
class MatchwithFiltersScreen extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <View style={[TabCommonStyle.container]}>
        ...
        <View style={TabCommonStyle.container}>
          ...
          {isSelectedTab == "Find_Match" ? (
            <FindMatchFilterScreen props={this.props} />
          ) : null}
        </View>
